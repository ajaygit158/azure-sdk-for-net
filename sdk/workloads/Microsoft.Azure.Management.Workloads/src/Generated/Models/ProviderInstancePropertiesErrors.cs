...
namespace Microsoft.Azure.Management.Workloads.Models
{
    ...
    public partial class ProviderInstancePropertiesErrors : Error
    {
        ...
        public ProviderInstancePropertiesErrors(string code = default(string), string message = default(string), string target = default(string), IList<Error> details = default(IList<Error>), ErrorInnerError innerError = default(ErrorInnerError))
