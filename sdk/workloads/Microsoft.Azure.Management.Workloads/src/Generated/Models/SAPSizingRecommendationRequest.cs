...
namespace Microsoft.Azure.Management.Workloads.Models
{
    ...
    public partial class SAPSizingRecommendationRequest
    {
        ...
        public SAPSizingRecommendationRequest(string appLocation, string environment, string sapProduct, string deploymentType, long saps, long dbMemory, string databaseType, string dbScaleMethod = default(string))
        {
