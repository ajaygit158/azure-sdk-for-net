...
namespace Microsoft.Azure.Management.Workloads.Models
{
    ...
    public partial class PhpWorkloadResource : TrackedResource
    {
        ...
        {
            base.Validate();
            if (InfraResourceGroup == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "InfraResourceGroup");
            }
            ...
            if (SiteProfile == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "SiteProfile");
            }
            if (AdminUserProfile != null)
            {
