...
namespace Microsoft.Azure.Management.Workloads.Models
{
    ...
    public partial class DatabaseProfile
    {
        ...
        /// Initializes a new instance of the DatabaseProfile class.
        /// </summary>
        /// <param name="adminUser">Admin user name for the database server
        /// resource</param>
        /// <param name="adminUserPassword">Admin user password for the
        /// database server resource</param>
        ...
        /// <param name="haEnabled">Enable HA or not for the server. Possible
        /// values include: 'Enabled', 'Disabled'</param>
        /// <param name="storageSku">SKU name for file storage</param>
        ...
        /// 'Disabled'</param>
        /// <param name="serverResourceId">Azure Database Server ARM Id</param>
        public DatabaseProfile(string adminUser, string adminUserPassword, string sku, DatabaseTier tier, string serverName = default(string), string version = default(string), string haEnabled = default(string), string storageSku = default(string), long? storageInGB = default(long?), long? storageIops = default(long?), int? backupRetentionDays = default(int?), string sslEnforcementEnabled = default(string), string serverResourceId = default(string))
        {
        ...
        /// <summary>
        /// Gets or sets admin user name for the database server resource
        /// </summary>
        [JsonProperty(PropertyName = "adminUser")]
        public string AdminUser { get; set; }

        /// <summary>
        /// Gets or sets admin user password for the database server resource
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets enable HA or not for the server. Possible values
        ...
        /// <summary>
        /// Gets or sets SKU name for file storage
        /// </summary>
        ...
        /// <summary>
        /// Gets azure Database Server ARM Id
        /// </summary>
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "AdminUserPassword");
            }
            if (Sku == null)
            {
