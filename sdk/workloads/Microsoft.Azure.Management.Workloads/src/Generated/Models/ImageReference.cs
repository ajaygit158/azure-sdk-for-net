...
namespace Microsoft.Azure.Management.Workloads.Models
{
    ...
    public partial class ImageReference
    {
        ...
        public ImageReference(string publisher = default(string), string offer = default(string), string sku = default(string), string version = default(string), string exactVersion = default(string), string sharedGalleryImageId = default(string))
        {
            Publisher = publisher;
            Offer = offer;
            Sku = sku;
