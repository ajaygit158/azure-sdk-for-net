...
namespace Microsoft.Azure.Management.Workloads.Models
{
    ...
    public partial class FileshareProfile
    {
        ...
        /// 'Premium_LRS'</param>
        /// <param name="shareSizeInGB">Fileshare size in GB</param>
        /// <param name="storageResourceId">Fileshare storage resource
        /// id</param>
        ...
        public virtual void Validate()
        {
            ...
            if (ShareSizeInGB > 1024)
            {
                throw new ValidationException(ValidationRules.InclusiveMaximum, "ShareSizeInGB", 1024);
            }
            if (ShareSizeInGB < 1)
            {
